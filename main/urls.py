...
urlpatterns = [
    ...
    path('adverts/', AdvertListView.as_view(),
         name='adverts-list'),
    path('adverts/<str:tag>/', AdvertListView.as_view(),
         name='adverts-list'),
    path('adverts/detail/<int:pk>/', AdvertDetailView.as_view(),
         name='advert-detail'),
    path('adverts/add/apartment/', ApartmentCreateView.as_view(),
         name='add_apartment'),
    path('adverts/add/house/', HouseCreateView.as_view(),
         name='add_house'),
    path('adverts/update/<slug:slug>/', AdvertUpdate.as_view(),
         name='update_advert'),
    # sitemap
